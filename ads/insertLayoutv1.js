...
function updateProductMetrics_ViewEvent(prod_url){
    ...
    window.onload = function() {
        ...
        var my_response = [
                    {
                        "category_boundary":"top:90%;left:60%;",
                    ...
                    {
                        "category_boundary":"top:8%;left:50%;",
...
/*                 $('.embed_container').append('<div class="simplifai-boundary-wrapper" data-category-name="'+my_response[items].category_name+'" style="'+my_response[items].category_boundary+'">'+
                '<div class="simplifai-boundary-animation">'+
